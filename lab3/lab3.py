...
class TriangleTest(unittest.TestCase):
	...
	# Проверяем, что функция calculateSquare выдает верный результат
	...
	# Проверяем, что функция calculateAngle выдает верный результат
	...
	def testIncorrectParamInCalculateSquare(self):
        ...
        #Проверяем, что функция calculateAngle когда неккоректное название угла, возращает False
	...
	# Проверяем, что функция getType выдает верный результат
